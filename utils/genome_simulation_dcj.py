...
def simulate_genomes(n_g, n_c, n_gf, n_dcj):
    ...
    folder_path = f'../dcj_test_files/sim_{n_g}_{n_gf}_{n_dcj}'

    if not os.path.exists(folder_path):
        os.makedirs(folder_path)

    convert_genome_to_file(t_og, t_dict, output_file_name=f'../dcj_test_files/sim_{n_g}_{n_gf}_{n_dcj}/sim_{n_g}_{n_gf}_{n_dcj}_og.dcj')
    convert_genome_to_file(g1_curr, d1_curr, output_file_name=f'../dcj_test_files/sim_{n_g}_{n_gf}_{n_dcj}/sim_{n_g}_{n_gf}_{n_dcj}_1.dcj')
    convert_genome_to_file(g2_curr, d2_curr, output_file_name=f'../dcj_test_files/sim_{n_g}_{n_gf}_{n_dcj}/sim_{n_g}_{n_gf}_{n_dcj}_2.dcj')
...
simulate_genomes(500, 10, 300, 100)
